...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-indigo-900 to-black">
      {/* Background pattern */}
      ...
      <motion.button
        ...
        className="absolute top-6 left-6 flex items-center gap-2 px-3 py-2 rounded-lg bg-white/10 text-white hover:bg-white/20 transition"
      >
        <ArrowLeft size={18} />
        Back
      </motion.button>
