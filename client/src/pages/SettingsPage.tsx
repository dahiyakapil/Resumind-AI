...
//   return (
//     <div className="space-y-10 max-w-4xl mx-auto px-6 py-10">
//       <h1 className="text-3xl font-bold text-foreground">⚙️ Account Settings</h1>

//       <section className="bg-muted p-6 rounded-2xl shadow-sm">
//         <h2 className="text-xl font-semibold mb-4">1. Choose Your Avatar</h2>
//         <AvatarPicker />
...
//       <section className="bg-muted p-6 rounded-2xl shadow-sm">
//         <h2 className="text-xl font-semibold mb-4">2. Update Profile Info</h2>
//         <ProfileForm />
//       </section>

//       <section className="bg-muted p-6 rounded-2xl shadow-sm">
//         <h2 className="text-xl font-semibold mb-4">3. Change Password</h2>
//         <PasswordForm />
//       </section>
//     </div>
//   );
