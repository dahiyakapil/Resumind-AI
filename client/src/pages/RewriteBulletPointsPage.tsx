// // RewriteLivePage.tsx (new or repurposed)
...
//     if (match) {
//       setApplied((prev) => ({ ...prev, [original]: match.rewritten }));
//     }
//   };
...
//         <Sparkles className="text-yellow-500" /> AI Suggestions for Bullet
//         Points
//       </h1>
...
//             Upload your resume to get live bullet suggestions.
//           </p>
//           <Button asChild>
...
// import { Button } from "@/components/ui/button";
// import { Card, CardContent } from "@/components/ui/card";
// import { Sparkles, UploadCloud, FileText, Download } from "lucide-react";
// import { cn } from "@/lib/utils";
// import type { AnalysisResponse } from "@/types/resumeAnalysis";
...
//   useEffect(() => {
//     const stored = localStorage.getItem("resume-analysis-latest");
//     if (stored) {
...
//     try {
//       const res = await axios.get(`${import.meta.env.VITE_BASE_URL}/resume/download/${reportId}`, {
//         responseType: "blob",
...
//       link.href = url;
//       link.download = `updated-${resumeName}`;
//       document.body.appendChild(link);
//       link.click();
//       document.body.removeChild(link);
//     } catch (err) {
//       toast.error("Failed to download updated PDF");
//     }
//   };
...
//       setReportId(parsed.reportId);
//       setApplied(
//         parsed.rewrites?.reduce((acc, r) => {
//           acc[r.original] = r.rewritten;
//           return acc;
...
//     try {
//       await axios.post(
//         `${import.meta.env.VITE_BASE_URL}/resume/download-updated/${reportId}`,
...
//*  IN THIS ALL AI SUGGESTIONS APPIELD WITHOUT A APPLY ALL BUTTON BAD USER EXPERIENCE
...
// DOWNLOAD PDS WITH AI SUGGESSTION RE WRITES

// import React, { useRef, useState, useEffect } from "react";
// import { useDispatch } from "react-redux";
// import type { AppDispatch } from "@/app/store";
// import { analyzeResume, downloadUpdatedPdfWithRewrites } from "@/app/features/resumeAnalysis/resumeAnalysisSlice";
// import { Button } from "@/components/ui/button";
// import { Card, CardContent } from "@/components/ui/card";
// import { Sparkles, UploadCloud, FileText, Download, RefreshCcw } from "lucide-react";
// import { cn } from "@/lib/utils";
